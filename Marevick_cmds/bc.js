...
zokou(_0x2f8f07, async (_0x3538d1, _0x3d7197, _0x5e996d) => {
  ...
  const _0x4ed112 = {
    ...
    'WUyKK': "*MAVERICK-MD is sending this message to all groups you are in*...",
    ...
    'NQvSP': "⚠️‼️ MAVERICK-MD BROADCAST‼️️⚠️\n\n❗*message* : ",
    'tCmLj': "\n\n️🌟 *Author*: ",
  ...
  await _0x2005ec("*MAVERICK-MD is sending this message to all groups you are in*...");
  for (let _0xeef539 of _0xd41245) {
    let _0x3fbe82 = "‼️⚠️MAVERICK-MD 𝐁𝐑𝐎ADCAST⚠️️‼️\n\n❗*message* : " + _0x2e8468 + "\n\n️‼️ *Author*: " + _0x358629;
    const _0x4da470 = {
